...
ZAP was built for [Sandstorm.io](https://sandstorm.io) and is heavily used in **Cloudflare Workers** — environments where security is paramount. ZAP has undergone fuzzing and expert security review.
