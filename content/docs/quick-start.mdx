...
# Install the Cap'n Proto compiler plugin
go install github.com/zap-protocol/zap/cmd/capnp-gen-zap@latest
```
</Tab>
<Tab value="Rust">
```bash
...
Create a file named `calculator.capnp`:
...
```bash
# Generate Go code
zap generate calculator.capnp --lang=go --out=./gen

# Generate Rust code
zap generate calculator.capnp --lang=rust --out=./gen

# Generate TypeScript code
zap generate calculator.capnp --lang=ts --out=./gen
```
