...
const browserCollections = {
  docs: create.doc("docs", {"api.mdx": () => import("../content/docs/api.mdx?collection=docs"), "architecture.mdx": () => import("../content/docs/architecture.mdx?collection=docs"), "consensus.mdx": () => import("../content/docs/consensus.mdx?collection=docs"), "gateway.mdx": () => import("../content/docs/gateway.mdx?collection=docs"), "index.mdx": () => import("../content/docs/index.mdx?collection=docs"), "protocol.mdx": () => import("../content/docs/protocol.mdx?collection=docs"), "quick-start.mdx": () => import("../content/docs/quick-start.mdx?collection=docs"), "transports.mdx": () => import("../content/docs/transports.mdx?collection=docs"), "why-zap.mdx": () => import("../content/docs/why-zap.mdx?collection=docs"), }),
};
